...
public class Player implements Serializable {
    ...
    public int lives; //keeps track of players lives
    ...
    /**
     * This method updates the lives of the player. If they lose a game, they lose a life.
     *
     * @param result tells us whether the player won the game or not
     */
    public void updateLives(boolean result){
        if (!result){
            this.lives -= 1;
        }
    }
    ...
    /**
     * Getter method for lives attribute
     *
